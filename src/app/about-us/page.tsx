            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-100 space-y-6">
                  ...
                  <div className="text-center sm:text-left space-y-1">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs text-slate-500 pt-2">
                      ...
                      <span className="flex items-center justify-center sm:justify-start gap-1">
                        ...
                        veronica@selasecurefinancial.com
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
                  <p>
                    Veronica is a Certified Financial Planner (CFP®) with
                    extensive experience in the financial services industry. She
                    began her career as a mortgage broker and later transitioned
                    into financial advising. This diverse background has allowed
                    Veronica to effectively guide families in managing both the
                    strategic (investment) and protective (insurance) aspects of
                    their financial well-being.
                  </p>
                  <p>
                    She is passionate about helping individuals, families, and
                    businesses create tailored plans to achieve their financial
                    goals and aspirations. As a Chartered Financial Divorce
                    Specialist (CFDS), Veronica helps individuals navigate the
                    financial complexities of divorce, providing expert guidance
                    on how to divide assets, manage liabilities, and address
                    financial matters during settlements.
                  </p>
                  <p>
                    Veronica lives in High River, just outside Calgary, with her
                    husband and two daughters. She travels regularly throughout
                    Alberta and British Columbia, providing comprehensive
                    financial guidance wherever it is needed.
                  </p>
                </div>
